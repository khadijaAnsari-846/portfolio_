...
export const BrainIcon = () => {
    ...
    return (
        <div
            className="w-40 h-40 mx-auto mb-8 rounded-full glassmorphism flex items-center justify-center lofi-glow cursor-pointer transition-transform duration-200"
        ...
        >
            <Cpu className="w-20 h-20 text-pink-300" />
        </div>
    );
};
